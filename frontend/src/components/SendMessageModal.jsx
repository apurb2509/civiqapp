  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex justify-center items-center z-50 p-4">
      <motion.div 
        ...
        className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl w-full max-w-lg border border-slate-700/50 overflow-hidden"
      >
        ...
        <form onSubmit={handleSendMessage}>
          <div className="p-8">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-40 p-4 bg-slate-900/50 text-white rounded-lg border border-slate-700/50 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent placeholder-gray-500 resize-none transition-all duration-200"
                required
              />
          ...
          <div className="px-8 py-5 bg-slate-800/30 border-t border-slate-700/50 flex justify-end gap-3">
            <button 
              type="button" 
              onClick={onClose} 
              className="px-5 py-2.5 text-gray-300 hover:text-white font-semibold rounded-lg hover:bg-slate-700/50 transition-all duration-200"
            >
              Cancel
            </button>
            <button 
              ...
              className="px-6 py-2.5 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold rounded-lg disabled:bg-slate-600 disabled:cursor-not-allowed transition-all duration-200 shadow-lg shadow-cyan-600/20 hover:shadow-cyan-500/30 flex items-center gap-2"
            >
              {isSending ? (
                <>
